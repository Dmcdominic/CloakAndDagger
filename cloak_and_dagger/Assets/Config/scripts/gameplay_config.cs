...
// Add options here
public enum gameplay_bool_option { heartbeat, initial_reveal, dagger_collaterals, daggers_destroy_daggers, daggers_destroy_fireballs, daggers_pierce_walls, fragile_reflect }
public enum gameplay_float_option { heartbeat_interval, dagger_cooldown, blink_cooldown, blink_range, reflect_time, respawn_delay, dagger_speed, dagger_light_radius, player_movespeed, bump_reveal_time, reflect_cooldown,
									fireball_cooldown, fireball_speed, fireball_light_range }
